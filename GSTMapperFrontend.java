...
public class GSTMapperFrontend implements IGSTMapperFrontend
{
    ...
    private IUPCChecker upcChecker;
	...
	public void removeItems()
	{
		...
		System.out.println("Which product would you like to add to cart? " + "1 - " + cart.size() + 1);
	...
	public void displayProducts(List<IProduct> products)
	{
		...
		System.out.println("Which product would you like to add to cart? " + "1 - " + products.size());
